...
This logic is very similar to Uniform Cost Search, but we care about the cost it takes to reach a path
'''
...
'''
uniform cost search
I use a heapq to find the optimal path with a heuristic and node
'''
